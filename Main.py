...
# Configuration
MAX_CONCURRENT = 1000  # Increase concurrency for faster requests
...
def main():
    ...
    print("=" * 40)
    engine.method = input("METHOD (default: C-ECPLISE): ").strip() or "C-ECPLISE"
    engine.target = input("TARGET URL: ").strip()
